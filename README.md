...
## Environments
- Preview: https://main--aem-edge-jamsheed--JamsheedAliU.aem.page/
- Live: https://main--aem-edge-jamsheed--JamsheedAliU.aem.live/
...
1. Open the `aem-edge-jamsheed` directory in your favorite IDE and start coding :)
